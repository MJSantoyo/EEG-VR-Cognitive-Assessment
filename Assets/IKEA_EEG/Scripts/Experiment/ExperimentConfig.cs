...
namespace IkeaEeg.Experiment
{
    ...
    public class ExperimentConfig : ScriptableObject
    {
        ...
        [Tooltip("Spoken PRE-TASK resting instructions, one clip per language. Generated by the " +
                 "same NarrationClipGenerator path as every other instruction clip. Empty until " +
                 "the clips are produced — the instruction is still readable on the panel.")]
        public List<NarrationClipEntry> preTaskRestNarrationClips =
            new List<NarrationClipEntry>();

        [Tooltip("Spoken POST-TASK resting instructions, one clip per language.")]
        public List<NarrationClipEntry> postTaskRestNarrationClips =
            new List<NarrationClipEntry>();
        ...
        /// <summary>PRE-TASK resting instructions for a language, or null.</summary>
        public AudioClip GetPreTaskRestNarration(
            Localization.ExperimentLanguage language) =>
            Lookup(preTaskRestNarrationClips,
                Localization.ExperimentLanguages.ToCode(language));

        /// <summary>POST-TASK resting instructions for a language, or null.</summary>
        public AudioClip GetPostTaskRestNarration(
            Localization.ExperimentLanguage language) =>
            Lookup(postTaskRestNarrationClips,
                Localization.ExperimentLanguages.ToCode(language));
